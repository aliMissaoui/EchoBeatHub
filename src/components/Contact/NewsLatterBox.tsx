...
const NewsLatterBox = () => {
  ...
  return (
    <div className="relative z-10 rounded-sm bg-white p-8 shadow-three dark:bg-gray-dark sm:p-11 lg:p-8 xl:p-11">
      ...
      Don’t miss out on exciting updates, new features, and special offers. Subscribe to our newsletter to stay informed about what's coming next. Enter your email below and be the first to know about our latest developments and exclusive content.
      </p>
      <div>
        <input
          type="text"
        ...
        <p className="text-center text-base leading-relaxed text-body-color dark:text-body-color-dark">
          Don't worry, no spam mails will be sent.
        </p>
      </div>
